...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Utilise la délégation d'événements pour capter AUSSI les liens
    // générés dynamiquement (ex: événements chargés depuis Firestore).
    ...
    document.addEventListener('click', (e) => {
        const link = e.target.closest('a.cta[href^="mailto:"]');
        if (!link) return;
